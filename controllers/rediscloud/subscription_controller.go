...
// +kubebuilder:rbac:groups=rediscloud.rediscloud.kubeform.com,resources=subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rediscloud.rediscloud.kubeform.com,resources=subscriptions/status,verbs=get;update;patch
...
func (r *SubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rediscloudv1alpha1.Subscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", rediscloudv1alpha1.Subscription{}.APIVersion, rediscloudv1alpha1.Subscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rediscloudv1alpha1.Subscription{}).
