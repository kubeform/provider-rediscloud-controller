...
// +kubebuilder:rbac:groups=subscription.rediscloud.kubeform.com,resources=subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=subscription.rediscloud.kubeform.com,resources=subscriptions/status,verbs=get;update;patch
...
func (r *SubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &subscriptionv1alpha1.Subscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", subscriptionv1alpha1.Subscription{}.APIVersion, subscriptionv1alpha1.Subscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&subscriptionv1alpha1.Subscription{}).
