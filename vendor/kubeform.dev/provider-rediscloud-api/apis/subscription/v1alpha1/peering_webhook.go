...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-subscription-rediscloud-kubeform-com-v1alpha1-peering,mutating=false,failurePolicy=fail,groups=subscription.rediscloud.kubeform.com,resources=peerings,versions=v1alpha1,name=peering.subscription.rediscloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
