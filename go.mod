module kubeform.dev/provider-rediscloud-controller

go 1.16

require (
	github.com/RedisLabs/terraform-provider-rediscloud v0.2.5-0.20210730144149-20f14a5c8cdc
	...
	kubeform.dev/provider-rediscloud-api v0.3.1-0.20210804233243-b960122abb50
