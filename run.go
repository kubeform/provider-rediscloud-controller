...
import (
	...
	rediscloudscheme "kubeform.dev/provider-rediscloud-api/client/clientset/versioned/scheme"
...
func init() {
	_ = rediscloudscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform rediscloud Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-rediscloud-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "rediscloud.kubeform.com",
			})
			if err != nil {
